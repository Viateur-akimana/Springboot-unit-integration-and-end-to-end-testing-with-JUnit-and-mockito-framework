...
class StudentServiceImplTest {
    ...
    private Student createMockStudent(Long id, String firstName, String lastName, String email) {
    ...
    private StudentDTO createMockStudentDTO(String firstName, String lastName, String email) {
    ...
    void shouldCreateStudent() {
        // Given
        StudentDTO studentDTO = createMockStudentDTO("John", "Doe", "john.doe@example.com");
        Student student = createMockStudent(1L, "John", "Doe", "john.doe@example.com");
    ...
    void shouldFetchAllStudents() {
        // Given
        Student student1 = createMockStudent(1L, "John", "Doe", "john.doe@example.com");
        Student student2 = createMockStudent(2L, "Jane", "Doe", "jane.doe@example.com");
    ...
    void shouldGetStudentById() {
        // Given
        Long studentId = 1L;
        Student student = createMockStudent(studentId, "John", "Doe", "john.doe@example.com");
    ...
    void shouldUpdateStudent() {
        // Given
        Long studentId = 1L;
        StudentDTO studentDTO = createMockStudentDTO("John", "Updated", "john.updated@example.com");
        Student existingStudent = createMockStudent(studentId, "John", "Doe", "john.doe@example.com");
